...
public class StartupData {
    ...
    public static List<Startup> initializeStartups() {
        return Arrays.asList(
            ...
            // Medical
            new Startup("Pfizer"         , "Medical", 4_200, 220, 17.0, 1_000, "Vaccine Vengeance", "Pill Push", "Cure Crash"), // # 5
            new Startup("Johnson&Johnson", "Medical", 4_100, 210, 16.0, 950, "Bandage Blockade", "Surgical Strike", "Healing Havoc"), // # 6
            new Startup("Bayer"          , "Medical", 4_000, 200, 15.0, 900, "Pill Pulverizer", "Formula Fiasco", "Prescription Panic"), // # 7

            // Military
            new Startup("Boeing"         , "Military", 2_600, 355, 21.0, 1_500, "Missile Strike", "Jetstream Juggernaut", "Aerospace Assault"), // # 8
            new Startup("Lockheed Martin", "Military", 2_500, 350, 20.0, 1_400, "Stealth Strike", "Radar Rip", "Lockdown Launch"), // # 9
            new Startup("Raytheon"       , "Military", 2_400, 340, 19.0, 1_300, "Missile Mayhem", "Radar Rampage", "Target Lock"), // # 10
